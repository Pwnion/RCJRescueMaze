...
public abstract class DrivingMotors {
	...
	public final void start2(String direction, long localMoveDuration2) {
		start2(direction, localMoveDuration2, 0);
	} // */
	
	
	//Moves the robot in the given direction using all 4 motors
	public final void start2(String direction, long localMoveDuration2, long delay) {
		System.out.println("start2(" + direction + ", " + localMoveDuration2 + ") + delay:" + delay);
		long moveDuration = Optional.of(localMoveDuration2).orElse(globalMoveDuration);
